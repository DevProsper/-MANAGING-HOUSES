...
<div class="wrapper wrapper-content animated fadeInRight ecommerce">
	...
	<div class="row">
		<div class="col-lg-12">
			<a href="index.php?module=admin.categories.add" class="btn btn-primary btn-md"><i class="fa fa-plus"></i> Ajouter une categorie</a><br><br>
			<div class="ibox">
				<div class="ibox-content">
					<table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
						...
						<tbody>
						<?php
						while ($categories = $requette->fetch()) {
							?>
							<tr>
								<td><?= $categories['id']?></td>
			...
			<nav aria-label="Page navigation">
				<ul class="pagination">
					<li>
						<a class="<?php if($current == '1'){ echo "disabled";} ?>" href="index.php?module=admin.categories.index&p=<?php if($current != '1'){echo $current-1;}else{ echo $current;} ?>" aria-label="Previous">
					...
					for ($i=1; $i <= $nbPage ; $i++) {
						if ($i == $current) {
							?>
							<li class="paginate-active"><a href="index.php?module=admin.categories.index&p=<?= $i ?>"><?= $i ?></a></li>
							<?php
						}else{
							?>
							<li><a href="index.php?module=admin.categories.index&p=<?= $i ?>"><?= $i ?></a></li>
							<?php
						}
					}
					?>
					...
					<li>
						<a class="<?php if($current == '1'){ echo "disabled";} ?>" href="index.php?module=admin.categories.index&p=<?php if($current != $nbPage){echo $current+1;}else{ echo $nbPage;} ?>" aria-label="Previous">
