...
<div class="wrapper wrapper-content animated fadeInRight ecommerce">
	<div class="row">
		<div class="col-md-10">
			<a href="index.php?module=admin.utilisateurs.index" type="submit" class="btn btn-sm btn-primary">ACTUALISE LA PAGE APRES LA RECHERCHE</a>
					...
					<table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
						...
						<?php foreach ($utilisateurs as $utilisateur): ?>
							<tr>
								...
								<td class="text-right">
									<div class="btn-group">
										<a href="index.php?module=admin.utilisateurs.edit&id=<?= $utilisateur['id'] ?>" class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i> Edit</a>
										<form action="index.php?module=admin.utilisateurs.delete" style="display: inline;" method="utilisateur">
